...
export function idbPromise(storeName, method, object) {
  return new Promise((resolve, reject) => {
    //open connection to the databae 'shop-shop' with version of 1
    ...
    request.onupgradeneeded = function (e) {
      ...
      //create objectstore for each type of data and set "primary" key index to be the _id of the data
    ...
    request.onsuccess = function (e) {
      ...
      //if there are erreors, let us know
